...
import heroImage from "@/assets/solution/05-Storage.jpg";
...
const Storage = () => {
  ...
  const seoTitle = isAr
    ? "حلول التخزين للمؤسسات - Lion Heart | Dell EMC، HPE، Pure Storage"
    : "Enterprise Storage Solutions - Lion Heart | Dell EMC, HPE, Pure Storage";
  
  const seoDescription = isAr
    ? "حلول تخزين متقدمة من Lion Heart - SAN، NAS، All-Flash. شريك Dell EMC، HPE، Pure Storage في دبي."
    : "Advanced storage solutions from Lion Heart - SAN, NAS, All-Flash. Dell EMC, HPE, Pure Storage partner in Dubai, UAE.";
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={isAr
          ? "حلول التخزين, SAN, NAS, Dell EMC, HPE, Pure Storage, دبي"
          : "storage solutions, SAN, NAS, Dell EMC, HPE, Pure Storage, Dubai, UAE"}
      />
