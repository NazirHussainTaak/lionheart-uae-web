...
import heroImage from "@/assets/solution/03-DataProtection.jpg";
...
const DataProtection = () => {
  ...
  const seoTitle = isAr
    ? "حماية البيانات للمؤسسات - Lion Heart | Veeam، النسخ الاحتياطي، الإمارات"
    : "Enterprise Data Protection - Lion Heart | Veeam, Backup, UAE";
  
  const seoDescription = isAr
    ? "حلول حماية البيانات من Lion Heart - النسخ الاحتياطي، الاسترداد، والأرشفة. شريك معتمد Veeam في دبي، الإمارات."
    : "Data protection solutions from Lion Heart - backup, recovery, and archiving. Certified Veeam partner in Dubai, UAE.";
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={isAr
          ? "حماية البيانات, النسخ الاحتياطي, Veeam, الاسترداد, دبي"
          : "data protection, backup, Veeam, recovery, disaster recovery, Dubai, UAE"}
      />
