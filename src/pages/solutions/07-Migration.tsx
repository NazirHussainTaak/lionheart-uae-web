...
import heroImage from "@/assets/solution/07-Migration.jpg";
...
const Migration = () => {
  ...
  const seoTitle = isAr
    ? "ترحيل التطبيقات والبيانات - Lion Heart | ترحيل السحابة، الإمارات"
    : "Application & Data Migration - Lion Heart | Cloud Migration, UAE";
  
  const seoDescription = isAr
    ? "خدمات الترحيل الخبيرة من Lion Heart - الترحيل السحابي، ترقية الأنظمة، ونقل البيانات. صفر وقت تعطل في دبي."
    : "Expert migration services from Lion Heart - cloud migration, system upgrades, and data transfers. Zero downtime in Dubai, UAE.";
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={isAr
          ? "الترحيل السحابي, ترحيل البيانات, ترقية الأنظمة, دبي"
          : "cloud migration, data migration, system upgrade, VMware, Dubai, UAE"}
      />
