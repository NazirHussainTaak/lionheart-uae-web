...
import heroImage from "@/assets/solution/06-NetworkingSecurity.jpg";

const NetworkingSecurity = () => {
  const { t, i18n } = useTranslation('networkingSecurity');
  const isAr = i18n.language === "ar";

  const seoTitle = isAr
    ? "الشبكات والأمن - Lion Heart | Cisco، Fortinet، Palo Alto Networks"
    : "Networking & Security - Lion Heart | Cisco, Fortinet, Palo Alto Networks";
  
  const seoDescription = isAr
    ? "حلول الشبكات والأمن من Lion Heart - جدران الحماية، VPN، Zero Trust. شريك Cisco، Fortinet، Palo Alto في دبي."
    : "Networking and security solutions from Lion Heart - firewalls, VPN, Zero Trust. Cisco, Fortinet, Palo Alto partner in Dubai, UAE.";
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={isAr
          ? "الشبكات, الأمن السيبراني, Cisco, Fortinet, Palo Alto, دبي"
          : "networking, cybersecurity, Cisco, Fortinet, Palo Alto, firewall, Dubai, UAE"}
      />
