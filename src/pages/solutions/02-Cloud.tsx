...
import heroImage from "@/assets/solution/02-Cloud.jpg";
...
const Cloud = () => {
  ...
  const seoTitle = isAr
    ? "الحلول السحابية - Lion Heart | AWS، Azure، Google Cloud في الإمارات"
    : "Cloud Solutions - Lion Heart | AWS, Azure, Google Cloud in UAE";
  
  const seoDescription = isAr
    ? "خدمات سحابية متقدمة من Lion Heart - الترحيل السحابي، الأمن، والبنية التحتية كخدمة. خبراء AWS، Azure، Google Cloud في دبي."
    : "Advanced cloud services from Lion Heart - migration, security, and IaaS. AWS, Azure, Google Cloud experts in Dubai, UAE.";
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={isAr
          ? "حلول سحابية, AWS, Azure, Google Cloud, الترحيل السحابي, دبي"
          : "cloud solutions, AWS, Azure, Google Cloud, cloud migration, Dubai, UAE"}
      />
