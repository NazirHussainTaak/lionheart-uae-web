...
import heroImage from "@/assets/solution/04-Converged.jpg";

const ConvergedSystems = () => {
  const { t, i18n } = useTranslation('converged');
  const isAr = i18n.language === "ar";

  const seoTitle = isAr
    ? "الأنظمة المتقاربة والمتقاربة الفائقة - Lion Heart | Nutanix، VMware"
    : "Converged & Hyperconverged Systems - Lion Heart | Nutanix, VMware";
  
  const seoDescription = isAr
    ? "حلول HCI و CI من Lion Heart - Nutanix، VMware، Dell VxRail. تبسيط البنية التحتية للمؤسسات في دبي، الإمارات."
    : "HCI and CI solutions from Lion Heart - Nutanix, VMware, Dell VxRail. Simplify enterprise infrastructure in Dubai, UAE.";
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={isAr
          ? "HCI, Nutanix, VMware, البنية المتقاربة, دبي"
          : "HCI, hyperconverged, Nutanix, VMware, VxRail, Dubai, UAE"}
      />
