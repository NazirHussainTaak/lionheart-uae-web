...
import heroImage from "@/assets/solution/01-Datacenter.jpg";

const DataCenter = () => {
  const { t, i18n } = useTranslation('dataCenter');
  const isAr = i18n.language === "ar";

  const seoTitle = isAr
    ? "حلول مراكز البيانات - Lion Heart | البنية التحتية للمؤسسات في الإمارات"
    : "Data Center Solutions - Lion Heart | Enterprise Infrastructure UAE";
  
  const seoDescription = isAr
    ? "حلول مراكز بيانات شاملة من Lion Heart - التصميم، النشر، والصيانة. شريك معتمد لـ HPE، Dell، Cisco في دبي."
    : "Comprehensive data center solutions from Lion Heart - design, deployment, and maintenance. Certified partner of HPE, Dell, Cisco in Dubai, UAE.";
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={isAr
          ? "مركز بيانات, البنية التحتية, HPE, Dell, Cisco, دبي, الإمارات"
          : "data center, infrastructure, HPE, Dell, Cisco, Dubai, UAE, enterprise"}
      />
