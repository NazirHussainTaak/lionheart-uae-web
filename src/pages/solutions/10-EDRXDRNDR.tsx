...
const EDRXDRNDR = () => {
  const { t, i18n } = useTranslation('edrXdrNdr');
  const isAr = i18n.language === "ar";

  return (
    <>
      <SEOHead
        title={isAr ? "EDR/XDR/NDR - Lion Heart" : "EDR/XDR/NDR - Lion Heart"}
        description={isAr ? "حلول EDR/XDR/NDR من Lion Heart" : "EDR/XDR/NDR solutions from Lion Heart"}
        keywords={isAr ? "EDR, XDR, NDR, الأمن السيبراني, دبي" : "EDR, XDR, NDR, cybersecurity, Dubai, UAE"}
      />
